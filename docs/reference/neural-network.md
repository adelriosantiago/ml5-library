...
This neural network learns how to multiply by 2. The training data contains 100 multiplications where `x` is the input number and `y` is the result of the multiplication. 
...
The result for `50` as an input is `100`, as expected.
